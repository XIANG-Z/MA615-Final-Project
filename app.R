...
ui <- fluidPage(
  tabsetPanel(
   ...
   tabPanel("Images",
            ...
            hr(),
            splitLayout(img(src="bitdefender.png", height=250, width=200),
                        img(src="kaspersky.jpg", height=250, width=200)),
            hr(),
            br(),
            splitLayout(
              h6("Bitdefender is a Romanian cybersecurity and anti-virus software company. 
              ...
              h6("Kaspersky Lab is a multinational cybersecurity and anti-virus provider headquartered in Moscow, 
            ...
            br(),
            splitLayout(
              a(href="https://store.google.com/product/google_home","Bitdefender", "Click to visit Bitdenfender website"),
              a(href="https://store.google.com/product/google_home","Kaspersky", "Click to visit Kaspersky website")
            ),
            br(),
            br(),
            br(),
...
server <- function(input, output) {
  ...
  output$map <- renderPlotly({
    ...
    map <- ggplot() +   mapWorld
    map <- map+ geom_point(aes(longitude,latitude), data = cyber_geo, color="dark red", size=2.5) 
    map <- map + theme_bw()
    ggplotly(map)
